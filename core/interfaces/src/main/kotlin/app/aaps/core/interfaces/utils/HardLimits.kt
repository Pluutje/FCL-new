...
interface HardLimits {
    companion object {
        ...
        val LIMIT_DIA = mapOf(
            ...
            AgeType.ADULT to 5.0..12.0,
            AgeType.RESISTANT_ADULT to 5.0..12.0,
            AgeType.PREGNANT to 5.0..12.0
        )
        ...
        val MAX_BASAL = mapOf(
            ...
            AgeType.TEENAGE to 5.0,
            AgeType.ADULT to 50.0,
            AgeType.RESISTANT_ADULT to 50.0,
            AgeType.PREGNANT to 50.0
        )
