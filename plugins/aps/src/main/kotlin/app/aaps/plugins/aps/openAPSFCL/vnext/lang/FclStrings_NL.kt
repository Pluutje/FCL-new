...
object FclStrings_NL : FclStrings {
    ...
    override val expertPeakStartTitel             = "Vroege-signalering drempel (testfase)"
    override val expertPeakStartUitleg            = "Hoe vroeg de voorspelde piek al hoog genoeg moet zijn voordat WatchingFrontload uberhaupt in aanmerking komt. Lager = eerder eligible, ook bij minder hoog voorspelde maaltijden. Standaard 9,0 mmol = huidig gedrag, ongewijzigd. Verlaag heel geleidelijk en volg de uitkomst zelf."
    override val expertPeakStartWaarde            = "Drempel: %.1f mmol/L"
